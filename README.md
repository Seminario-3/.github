# Seminários III - Ciência da Computação - PPC - Noite - 2025/1
```Sistema acessível de matemática básica para deficientes auditivos.```
<br></br>
## Integrantes
...
| Etapa               | Atividades                                                           |
|---------------------|----------------------------------------------------------------------|
| Etapa 1       | <a href='#'>Definição do grupo e tema da aplicação </a>                                    |
| Etapa 2       | <a href='#'>Definição do objetivo, problema, motivação</a> <br> <a href='#'>Elaboração inicial de conteúdos</a>                                |
